...
class ConsultationsTypeState extends State<ConsultationsType> {
  ...
  Future<void> _loadCustomerProfile() async {
    final prefs = await SharedPreferences.getInstance();
    final customer = await prefs.getString('customer_full_name');
  ...
  Future<void> showWelcomeRewardBottomSheet() async {
    ...
    // ⚠️ As per your logic: if NOT already shown → return
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const Text(
                      "100 NGK Reward Coins have been added to your account",
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton(
                        ...
                        onPressed: () async {
                          ...
                          Get.to(
                            () => ReferralWalletPage(mobile: mobile),
                          );
                        },
                        child: const Text(
                          "Start Exploring",
